...
- Các thư viện bên ngoài:**
    ...
    * TinyXML2: Đã được tích hợp sẵn trong mã nguồn (`tinyxml2.cpp`) và (`tinyxml2.h`), không cần cài đặt.
  **Link tải thư viện TinyXML: **https://github.com/leethomason/tinyxml2**
